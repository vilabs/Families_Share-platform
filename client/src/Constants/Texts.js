...
const nl = {
  ...
  memberContact: {
    administrator: 'Groep admin', addAdmin: 'Admin toevoegen', removeAdmin: 'Admin verwijderen', removeUser: 'Verwijder gebruiker',
  },
  startUpGuide: { backNavTitle: 'Opstart gids', guide: [{ main: 'Lanceer het initiatief binnen je kring', secondary: null }, { main: 'Verenig de eerste enthousiastelingen', secondary: null }, { main: 'Contacteer de locatie', secondary: null }, { main: 'Maak interne afspraken', secondary: null }, { main: 'Sluit de agenda', secondary: null }, { main: 'Kick-off!', secondary: null }, { main: 'Welkom', secondary: null }] },
  notificationScreen: { backNavTitle: 'Notificaties' },
  myFamiliesShareHeader: {
    confirmDialogTitle: 'Wilt u dat een walkthrough van het platform naar uw e-mail wordt verzonden?', walkthrough: 'Opstartgids', rating: 'Beoordeel ons', header: 'Mijn Families Share', homeButton: 'Home', myProfileButton: 'Mijn profiel', createGroup: 'Start een groep', searchGroup: 'Zoek een groep', inviteFriends: 'Nodig vrienden uit', faqs: "FAQ's", about: 'Over', signOut: 'Afmelden', language: 'Taal', export: 'Exporteer mijn data',
  },
  ...
  createGroupStepper: {
    continue: 'Ga verder', cancel: 'Annuleer', finish: 'Voltooien', stepLabels: ['Voorzie een naam en beschrijving', 'Zet je zichtbaarheid', 'Geef je locatie mee', 'Nodig mensen uit'], name: 'Naam', description: 'Beschrijving', visibleGroup: 'Anderen kunnen mijn groep vinden', invisibleGroup: 'Anderen kunnen mijn groep niet vinden', city: 'Stad', invite: 'Leden toevoegen', nameError: 'Deze groepsnaam bestaat al',
  },
  profileNavbar: { framily: 'Vrienden', info: 'Info', children: 'Kinderen' },
  profileInfo: {
    adress: 'Adres', email: 'Persoonlijk', mobile: 'Mobiel', home: 'Thuis', unspecified: 'Ongedefinieerd',
  },
  ...
  createChildScreen: {
    backNavTitle: 'Voeg kind toe', save: 'Opslaan', name: 'Voornaam', surname: 'Achternaam', birthday: 'Geboortedag', gender: 'Geslacht', additional: 'Voeg specifieke info toe', add: 'Voeg toe', edit: 'Pas aan', example: 'bv. voedingsintoleranties', boy: 'Jongen', girl: 'Meisje', date: 'Datum', month: 'Maand', year: 'Jaar', acceptTerms: 'Ik ga akkoord met de gebruiksvoorwaarden en het privacybeleid inzake de verwerking van mijn gegevens.', acceptTermsError: 'Gelieve akkoord te gaan met de voorwaarden', unspecified: 'Ongedefinieerd',
  },
  additionalInfoScreen: {
    backNavTitle: 'Informatie', save: 'Opslaan', allergy: 'Allergie', special: 'Specialen noden', others: 'Andere', acceptTerms: 'Ik erken dat deze info meegedeeld zal worden met groepsleden die direct betrokken zijn bij de kinderactiviteiten.',
  },
  ...
  createActivityTimeslots: { header: 'Voeg een timeslot toe aan de geselecteerde dagen', differentTimeslots: 'Verschillende timeslots voor iedere dag?', sameTimeslots: 'Zelfde timeslots voor iedere dag?' },
  timeslotsContainer: {
    addTimeslot: 'Voeg timeslot toe', timeslot: 'timeslot', timeslots: 'timeslots', confirmDialogTitle: 'Ben je zeker dat je dit timeslot wilt verwijderen', timeRangeError: 'Onmogelijke combinatie van start en eind tijd',
  },
  clockModal: {
  ...
  filterTimeslotsDrawer: {
    header: 'Filter timeslots', all: 'Alle timeslots', signed: 'Mijn ingeschreven timeslots', enough: 'Met genoeg deelnemers', notEnough: 'Met te weining deelnemers',
  },
  expandedTimeslot: {
  ...
  forgotPasswordScreen: {
    prompt: 'Vul email adres in om een link te ontvangen waarmee je je wachtwoord kan veranderen', email: 'Email', backNavTitle: 'Wachtwoord vergeten', send: 'Verstuur', notExistError: 'Gebruiker bestaat niet', error: 'Er ging iets mis', success: 'Email verzonden',
  },
  changePasswordScreen: {
    prompt: 'Kies je nieuwe wachtwoord', password: 'Wachtwoord', confirm: 'Bevestig wachtwoord', change: 'Verander', error: 'Wachtwoorden komen niet overeen', badRequest: 'Foutief verzoek',
  },
...
const it = {
  ...
  memberContact: {
    administrator: 'Amministratore del gruppo', addAdmin: 'Aggiungi amministratore', removeAdmin: 'Rimuovi amministratore', removeUser: 'Rimuovi utente',
  },
  startUpGuide: { backNavTitle: 'Come iniziare', guide: [{ main: "Fai conoscere l'iniziativa ad altre persone", secondary: null }, { main: 'Raccogli i primi riscontri positivi', secondary: null }, { main: 'Trova un luogo ideale', secondary: null }, { main: 'Definisci delle cariche interne', secondary: null }, { main: "Chiudi l'agenda", secondary: null }, { main: 'Si parte!', secondary: null }, { main: 'Benvenuti', secondary: null }] },
  notificationScreen: { backNavTitle: 'Notifica' },
  myFamiliesShareHeader: {
    confirmDialogTitle: 'Vuoi una soluzione della piattaforma da inviare alla tua email?', walkthrough: "Guida all'avviamento", rating: 'Votaci', header: 'Il mio Families Share', homeButton: 'Home page', myProfileButton: 'Il mio profilo', createGroup: 'Crea un gruppo', searchGroup: 'Cerca un gruppo', inviteFriends: 'Invita amici', faqs: 'FAQs', about: 'Il progetto', signOut: 'Esci ', language: 'Lingua', export: 'Esporta i miei dati',
  },
  ...
  createGroupStepper: {
    continue: 'Continua', cancel: 'Cancella', finish: 'Termina', stepLabels: ['Fornisci nome e descrizione', 'Imposta la visibilità del gruppo', 'Indica un luogo', 'Invita persone'], name: 'Nome', description: 'Descrizione', visibleGroup: 'Altri utenti possono trovare il gruppo', invisibleGroup: 'Altri utenti NON possono trovare il gruppo', city: 'Città', invite: 'Aggiungi membri', nameError: 'Il nome scelto è già in uso da un altro gruppo',
  },
  profileNavbar: { framily: 'AMICI', info: 'INFO', children: 'BAMBINI' },
  profileInfo: {
    adress: 'Indirizzo', email: 'Contatto personale ', mobile: 'Cellulare', home: 'Telefono', unspecified: 'Non specificato',
  },
  ...
  reply: { confirmDialogTitle: 'Confermi di voler eliminare la tua risposta?' },
  groupHeader: { confirmDialogTitle: 'Confermi di voler eliminare il gruppo?' },
  announcementHeader: { confirmDialogTitle: "Confermi l'eliminazione?" },
  ...
  createChildScreen: {
    backNavTitle: 'Aggiungi un/a bambino/a', save: 'SALVA', name: 'Nome', surname: 'Cognome', birthday: 'Compleanno', gender: 'Genere', additional: 'Aggiungi informazioni', add: 'AGGIUNGI', edit: 'MODIFICA', example: 'es., intolleranze alimentari', boy: 'Bambino', girl: 'Bambina', date: 'Data', month: 'Mese', year: 'Anno', acceptTerms: "Accetto i Termini d'Uso e l'Informativa sulla Privacy per il trattamento e utilizzo dei miei dati.", acceptTermsError: "Si prega di accettare i termini d'uso e l'informativa sulla provacy per procedere", unspecified: 'Non specificato',
  },
  additionalInfoScreen: {
    backNavTitle: 'Informazioni', save: 'SALVA', allergy: 'Allergia', special: 'Bisogni speciali', others: 'Altri', acceptTerms: 'Acconsento che queste informazioni siano condivise con i membri del gruppo direttamente coinvolti nelle attività di cura dei figli ("childcare") ',
  },
  createActivityScreen: { backNavTitle: 'Nuova attività' },
  createActivityStepper: {
    continue: 'Continua', cancel: 'Cancella', finish: 'Crea', save: 'Salva', stepLabels: ['Informazioni', 'Date', 'Orari'],
  },
  createActivityInformation: { color: "Colore dell'attività", description: 'Descrizione (facoltativo)', name: "Titolo dell'attività" },
  createActivityDates: {
    header: 'Seleziona uno o più giorni', repetition: 'Ripetizione', weekly: 'Settimanale', monthly: 'Mensile', datesError: 'La ripetizione non è disponibile quando sono selezionati più giorni',
  },
  createActivityTimeslots: { header: 'Aggiungi una fascia oraria nei giorni selezionati', differentTimeslots: 'AGGIUNGERE ORARI DIFFERENTI PER OGNI GIORNATA?', sameTimeslots: 'STESSI ORARI PER OGNI GIORNATA?' },
  timeslotsContainer: {
    addTimeslot: 'AGGIUNGI ORARI', timeslot: 'orario', timeslots: 'orari', confirmDialogTitle: 'Confermi di eliminare questo orario?', timeRangeError: 'Orario di inizio e fine non compatibili',
  },
  clockModal: {
  ...
  filterTimeslotsDrawer: {
    header: 'Filtra orari', all: 'Tutti gli orari', signed: 'Le mie adesioni', enough: 'Con abbastanza partecipanti', notEnough: 'Senza abbastanza partecipanti',
  },
  expandedTimeslot: {
  ...
  agendaView: {
    timeslots: 'Orari', available: 'disponibile', all: 'Tutti gli orari', signed: 'Le mie adesioni', enough: 'Con abbastanza participanti', notEnough: 'Senza abbastanza partecipanti', notEnoughParticipants: 'Non ci sono abbastanza partecipanti',
  },
  confirmDialog: { agree: 'SI', disagree: 'NO' },
  pendingRequestsScreen: {
    requests: 'Richieste in sospeso', activities: 'Attivita in sospeso', invites: 'Inviti in sospeso', confirm: 'CONFERMA', delete: 'ELIMINA',
  },
  forgotPasswordScreen: {
    prompt: "Inserisci l'indirizzo e-mail per ricevere il link per cambiare la tua Password. ", email: 'Email', backNavTitle: 'Password dimenticata?', send: 'INVIA', notExistError: "L'utente non è registrato nella piattaforma", error: 'Qualcosa è andato storto', success: 'Email inviata',
  },
  changePasswordScreen: {
    prompt: 'Inserisci la password', password: 'Password', confirm: 'Conferma la password', change: 'CAMBIA', error: 'Le due password sono differenti', badRequest: 'Richiesta errata',
  },
  calendar: { userCalendar: 'Mio calendario', groupCalendar: 'Gruppo calendario' },
  framilyListItem: { delete: '' },
};
...
const el = {
  ...
  memberContact: {
    administrator: 'Διαχειριστής ομάδας', addAdmin: 'Προσθήκη διαχειριστή', removeAdmin: 'Κατάργηση διαχειριστή', removeUser: 'Κατάργηση χρήστη',
  },
  startUpGuide: { backNavTitle: 'Οδηγός εκκίνησης', guide: [{ main: 'Ξεκινήστε την πρωτοβουλία στον κύκλο σας', secondary: null }, { main: 'Συνδέστε τους πρώτους ενθουσιώδεις', secondary: null }, { main: 'Επικοινωνείστε με τη τοποθεσία', secondary: null }, { main: 'Κάντε εσωτερικά ραντεβού', secondary: null }, { main: 'Κλείστε την ατζέντα /Επιβεβαιώστε την αντζέντα', secondary: null }, { main: 'Ξεκινήστε!', secondary: null }, { main: 'Καλώς ήρθατε', secondary: null }] },
  notificationScreen: { backNavTitle: 'Ειδοποήση' },
  myFamiliesShareHeader: {
    confirmDialogTitle: 'Επιθυμείτε να σας στείλουμε ένα εγχειρίδιο χρήσης της πλατφόρμας στο e-mail σας;', walkthrough: 'Εγχειρίδιο Χρήσης', rating: 'Βαθμολογήστε μας', header: 'Το Families Share μου ', homeButton: 'Αρχική σελίδα', myProfileButton: 'Το προφίλ μου', createGroup: 'Δημιουργήστε μια ομάδα', searchGroup: 'Αναζήτηστε  μια ομάδα', inviteFriends: 'Προσκαλέστε φίλους', faqs: 'Συχνές ερωτήσεις', about: 'Σχετικά με', signOut: 'Αποσύνδεση', language: 'Γλώσσα', export: 'Εξαγωγή των δεδομένων μου',
  },
  ...
  createGroupStepper: {
    continue: 'Συνέχεια', cancel: 'Ακύρωση', finish: 'Τέλος', stepLabels: ['Δώστε ένα όνομα και μια περιγραφή', 'Ορίστε την ορατότητα', 'Δώστε την τοποθεσία', 'Προσκαλέστε άτομα'], name: 'Όνομα', description: 'Περιγραφή', visibleGroup: 'Άλλοι μπορούν να βρουν την ομάδα μου', invisibleGroup: 'Άλλοι δεν μπορούν να βρουν την ομάδα μου', city: 'Πόλη', invite: 'Προσθήκη μελών', nameError: 'Το όνομα της ομάδας υπάρχει ήδη',
  },
  profileNavbar: { framily: 'ΦΙΛΟΙ', info: 'ΠΛΗΡΟΦΟΡΙΕΣ', children: 'ΠΑΙΔΙΑ' },
  profileInfo: {
    adress: 'Διεύθυνση', email: 'Προσωπικό', mobile: 'Κινητό (τηλέφωνο)', home: 'Σταθερό (τηλέφωνο)', unspecified: 'Απροσδιόριστο',
  },
  ...
  announcementHeader: { confirmDialogTitle: 'Είστε σίγουροι ότι θέλετε να το διαγράψετε;' },
  ...
  createChildScreen: {
    backNavTitle: 'Προσθήκη παιδιού', save: 'ΑΠΟΘΗΚΕΥΣΗ', name: 'Όνομα', surname: 'Επίθετο', birthday: 'Ημερομηνία Γέννησης', gender: 'Φύλο', additional: 'Προσθέστε συγκεκριμένες πληροφορίες', add: 'Προσθήκη ', edit: 'Επεξεργασία', example: 'π.χ. δυσανεξία σε τρόφιμα', boy: 'Αγόρι', girl: 'Κορίτσι', date: 'Ημερομηνία', month: 'Μηνών ', year: 'Ετών', acceptTerms: 'Αποδέχομαι τους Όρους Χρήσης και την Πολιτική όσον αφορά την επεξεργασία και τη χρήση των δεδομένων μου.', acceptTermsError: 'Παρακαλώ αποδεχτείτε τους όρους', unspecified: 'Απροσδιόριστο',
  },
  additionalInfoScreen: {
    backNavTitle: 'Πληροφορίες', save: 'ΑΠΟΘΗΚΕΥΣΗ', allergy: 'Αλλεργίες', special: 'Ειδικές ανάγκες', others: 'Άλλα', acceptTerms: 'Αναγνωρίζω ότι αυτές οι πληροφορίες θα γνωστοποιηθούν στα μέλη της ομάδας που συμμετέχουν άμεσα στις δραστηριότητες παιδικής μέριμνας.',
  },
  ...
  createActivityTimeslots: { header: 'Προσθέστε χρονική περίοδο στις επιλεγμένες ημέρες', differentTimeslots: 'ΔΙΑΦΟΡΕΤΙΚΗ ΧΡΟΝΙΚΗ ΠΕΡΙΟΔΟΣ ΓΙΑ ΚΑΘΕ ΗΜΕΡΑ;', sameTimeslots: 'ΙΔΙΑ ΧΡΟΝΙΚΗ ΠΕΡΙΟΔΟΣ ΓΙΑ ΚΆΘΕ ΗΜΕΡΑ;' },
  timeslotsContainer: {
    addTimeslot: 'Προσθήκη χρονικής περιόδου', timeslot: 'Χρονική περίοδος', timeslots: 'Χρονικές περίοδοι', confirmDialogTitle: 'Είστε βέβαιοι ότι θέλετε να διαγράψετε αυτή την χρονική περίοδο;', timeRangeError: 'Μη έγκυρος συνδυασμός χρόνου έναρξης και λήξης',
  },
  clockModal: {
  ...
  filterTimeslotsDrawer: {
    header: 'Φίλτρα χρονικής περιόδου', all: 'Όλες οι χρονικές περίοδοι', signed: 'Η εγγραφή μου', enough: 'Με αρκετούς συμμετέχοντες', notEnough: 'Χωρίς αρκετούς συμμετέχοντες',
  },
  expandedTimeslot: {
  ...
  forgotPasswordScreen: {
    prompt: 'Πληκτρολογήστε τη διεύθυνση ηλεκτρονικού ταχυδρομείου σας (το email) σας για να λάβετε έναν σύνδεσμο και να αλλάξετε τον κωδικό πρόσβασής σας', email: 'Ηλεκτρονικό ταχυδρομείο', backNavTitle: 'Ξεχάσα τον κωδικό', send: 'ΑΠΟΣΤΟΛΗ', notExistError: 'Ο χρήστης δεν υπάρχει', error: 'Κάτι πήγε στραβά', success: 'Το μήνυμα ηλεκτρονικού ταχυδρομείου εστάλη',
  },
  changePasswordScreen: {
    prompt: 'Παρακαλώ εισαγάγετε τον νέο κωδικό πρόσβασής', password: 'Κωδικός πρόσβασης', confirm: 'Επιβεβαίωση κωδικού πρόσβασης', change: 'ΑΛΛΑΓΗ', error: 'Οι κωδικοί πρόσβασης δεν ταιριάζουν', badRequest: 'Σφάλμα Πρόσβασης',
  },
  calendar: { userCalendar: 'Το ημερολόγιο μου', groupCalendar: 'Το ημερολόγιο της ομάδας' },
  framilyListItem: { delete: '' },
};

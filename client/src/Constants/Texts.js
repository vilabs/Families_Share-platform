...
const nl = {
	...
	forgotPasswordScreen: {
		prompt: 'Vul email adres in om een link te ontvangen waarmee je je wachtwoord kan veranderen',
		email: 'Email',
...
const it = {
	...
	forgotPasswordScreen: {
		prompt: "Inserisci l'indirizzo e-mail per ricevere il link per cambiare la tua Password. ",
		email: 'Email',
...
const el = {
	...
	logInForm: {
		password: 'Κωδικός πρόσβασης', email: ' Ηλεκτρονικό ταχυδρομείο', confirm: 'Επιβεβαίωση', authenticationErr: 'Λάθος διεύθυνση  ηλεκτρονικού ταχυδρομείου ή κωδικός πρόσβασης', requiredErr: 'Παρακαλούμε συμπληρώστε αυτό το πεδίο.', typeMismatchErr: 'Παρακαλούμε εισάγετε μια έγκυρη διεύθυνση e-mail.', tooShortErr: 'Παρακαλούμε χρησιμοποιήσετε τουλάχιστον 8 χαρακτήρες.'
	},
	...
	forgotPasswordScreen: {
		prompt: 'Πληκτρολογήστε τη διεύθυνση ηλεκτρονικού ταχυδρομείου σας (το email) σας για να λάβετε έναν σύνδεσμο και να αλλάξετε τον κωδικό πρόσβασής σας',
		email: 'Ηλεκτρονικό ταχυδρομείο',

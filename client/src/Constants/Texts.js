...
const nl = {
	...
	createChildScreen: {
		...
		month: 'Maand',
		year: 'Jaar',
		acceptTerms: 'Ik ga akkoord met de gebruiksvoorwaarden en het privacybeleid inzake de verwerking van mijn gegevens.',
	...
	expandedTimeslotEdit: {
		...
		footer: 'Aanpassingen worden enkel toegebracht binnen dit timeslot, niet voor de gehele activiteit',
		name: 'Titel',
		location: 'Locatie',
...
const it = {
	...
	profileHeader: {
		...
		delete: 'Elimina',
		signout: 'Esci',
		exportDialogTitle: 'Sei sicuro di voler esportare tutte le tue informazioni personali?',
	...
	childProfileHeader: {
		...
		confirmDialogTitle: 'Confermi di voler eliminare il profilo di questo bambino/a?'
	},
	childProfileInfo: {
		confirmDialogTitle: 'Sei sicuro di voler eliminare questo genitore?',
		boy: 'Maschio', girl: 'Femmina',
		unspecified: 'Non specificato',
		age: 'Età',
	...
	createChildScreen: {
		...
		month: 'Mese',
		year: 'Anno',
		acceptTerms: "Accetto i Termini d'Uso e l'Informativa sulla Privacy per il trattamento e utilizzo dei miei dati.",
		acceptTermsErr: "Si prega di accettare i termini d'uso e l'informativa sulla provacy per procedere",
		unspecified: 'Non specificato',
		requiredErr: 'Perfavore compila questo campo.',
	},
	additionalInfoScreen: {
		...
		others: 'Altri',
		acceptTerms: 'Acconsento che queste informazioni siano condivise con i membri del gruppo direttamente coinvolti nelle attività di cura dei figli ("childcare") ',
	},
	createActivityScreen: { 
	...
	createActivityDates: {
		...
		weekly: 'Settimanale',
		monthly: 'Mensile',
		datesError: 'La ripetizione non è disponibile quando sono selezionati più giorni',
	},
	createActivityTimeslots: {
	...
	expandedTimeslotEdit: {
		...
		footer: "Le modifiche saranno apportate solo a questo orario e non all'attività",
		name: 'Titolo',
		location: 'Luogo',
...
const el = {
	...
	createGroupStepper: {
		...
		city: 'Πόλη', invite: 'Προσθήκη μελών',
	...
	createChildScreen: {
		...
		month: 'Μηνών ',
		year: 'Ετών',
		acceptTerms: 'Αποδέχομαι τους Όρους Χρήσης και την Πολιτική όσον αφορά την επεξεργασία και τη χρήση των δεδομένων μου.',
	...
	expandedTimeslotEdit: {
		...
		footer: 'Οι αλλαγές θα γίνουν μόνο σε αυτήν την χρονική περίοδο και όχι στη δραστηριότητα',
		name: 'Τίτλος',
		location: 'Τοποθεσία',

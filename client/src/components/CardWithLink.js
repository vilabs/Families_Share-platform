...
const Card = (props) => {
    ...
    return(
      ...
      <CardContent>
        ...
        <Typography className={card.learnMore?classes.infoWithButton:classes.info}>
          {card.cardInfo}
        </Typography>
      </CardContent>
			{card.learnMore &&
      <CardActions>
        <Button size='small' className={classes.button} onClick={handleClick}>{texts.learnMore}</Button>
      </CardActions>}
    </MCard>
    );
}
